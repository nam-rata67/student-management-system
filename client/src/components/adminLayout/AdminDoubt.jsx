...
function AdminDoubt() {
  ...
  const sendReply = async (id) => {
    ...
    await axios.post(
      `https://student-management-system-using-mern-in35.onrender.com/api/doubts/reply/${id}`,
      formData,
  ...
  const deleteDoubt = async (id) => {
    ...
    await axios.delete(`https://student-management-system-using-mern-in35.onrender.com/api/doubts/${id}`);
    loadDoubts();
  };
    ...
    <div style={{ padding: 20 }}>
      ...
      {doubts.map((d) => (
        <div key={d._id} style={{
          ...
          {d.studentFile && (
            <a href={`https://student-management-system-using-mern-in35.onrender.com/uploads/${d.studentFile}`} target="_blank" rel="noreferrer">
              📎 Student File
            </a>
          )}
          ...
          {d.status === "Answered" && (
            <>
              ...
              {d.adminFile && (
                <a href={`https://student-management-system-using-mern-in35.onrender.com/uploads/${d.adminFile}`} target="_blank" rel="noreferrer">
                  📂 Admin File
                </a>
              )}
            </>
